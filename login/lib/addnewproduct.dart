    ...
    if (user != null) {
      ...
      if (userSnapshot.exists) {
        setState(() {
          ...
          phoneNumber = userSnapshot['Phone'] ?? 'No phone number';
          email = userSnapshot['Email'] ?? 'No email';
        });
      }
    }
  }
                  ...
                  children: [
                    Center(
                      child: GestureDetector(
                        onTap: pickImage,
                        child: Column( // Wrap the GestureDetector with Column
                          children: [
                            SizedBox(height: 40),
                            CircleAvatar(
                              radius: 50,
                            ...
                            Text(
                              'Add Profile Image', // Add Profile Image text
                              style: TextStyle(
                                fontSize: 14,
                            ...
                            Divider(
                              height: 8,
                              thickness: 2,
                              indent: 0, // Increase indent to increase width on the leading side
                              endIndent: 0,
                            ),
                          ],
                        ),
